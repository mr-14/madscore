...
export class SVGContext {
  ...
  openGroup(cls, id, attrs) {
    ...
    this.parent = group;
    if (cls) group.setAttribute('class', CommonUtil.Prefix(cls));
    if (id) group.setAttribute('id', CommonUtil.Prefix(id));
  ...
  setFont(family, size, weight) {
    ...
    CommonUtil.Merge(this.attributes, fontAttributes);
    CommonUtil.Merge(this.state, fontAttributes);
  ...
  setLineDash(lineDash) {
    if (Object.prototype.toString.call(lineDash) === '[object Array]') {
      ...
      throw new CommonUtil.RERR('ArgumentError', 'lineDash must be an array of integers.');
    }
  }
  ...
  fill(attributes) {
    ...
    if (typeof attributes === 'undefined') {
      attributes = {};
      CommonUtil.Merge(attributes, this.attributes);
